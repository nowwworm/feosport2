...
function getInstructions(): string {
  return `
  <b>${t('pages.participants.sheetsLink.sharingRequirements', 'Sharing Requirements')}</b>
  <ul>
    <li>${t('pages.participants.sheetsLink.openSheet', 'Open your Google Sheet')}</li>
    <li>${t('pages.participants.sheetsLink.clickShare', 'Click "Share" button (top right)')}</li>
    <li>${t('pages.participants.sheetsLink.setPublic', 'Set to "Anyone with the link can view"')}</li>
    <li>${t('pages.participants.sheetsLink.copyLink', 'Copy the shareable link')}</li>
  </ul>
  <br>
  <b>${t('pages.participants.sheetsLink.requiredColumns', 'Required Columns')}</b>
  <ul>
    <li><strong>First Name</strong> ${t('pages.participants.sheetsLink.orAlias', '(or "first", "first_name")')}</li>
    <li><strong>Last Name</strong> ${t('pages.participants.sheetsLink.orAliasLast', '(or "last", "last_name")')}</li>
  </ul>
  <br>
  <b>${t('pages.participants.sheetsLink.optionalColumns', 'Optional Columns')}</b>
  <ul>
    <li><strong>id</strong> or <strong>participantid</strong> - ${t('pages.participants.sheetsLink.uniqueId', 'Unique identifier')}</li>
    <li><strong>Gender</strong> or <strong>sex</strong> - MALE, FEMALE, M, F, W, B, G</li>
    <li><strong>Birth Date</strong> - ${t('pages.participants.sheetsLink.dateFormat', 'Format: YYYY-MM-DD')}</li>
    <li><strong>IOC</strong>, <strong>country</strong>, or <strong>nationality</strong> - ${t('pages.participants.sheetsLink.countryCode', '3-letter country code')}</li>
    <li><strong>City</strong> - ${t('pages.participants.sheetsLink.cityResidence', 'City of residence')}</li>
    <li><strong>State</strong> - ${t('pages.participants.sheetsLink.stateProvince', 'State/province')}</li>
    <li><strong>Tennis ID</strong> - ${t('pages.participants.sheetsLink.tennisId', 'Official tennis organization ID')}</li>
    <li><strong>UTR</strong> - Universal Tennis Rating (numeric)</li>
    <li><strong>WTN</strong> - World Tennis Number (numeric)</li>
    <li><strong>UTR Profile</strong> - ${t('pages.participants.sheetsLink.utrProfile', 'Link to UTR profile page')}</li>
  </ul>
  <br>
  <b>${t('pages.participants.sheetsLink.columnFlexibility', 'Column Name Flexibility')}</b>
  <ul>
    <li>${t('pages.participants.sheetsLink.caseInsensitive', 'Column names are case-insensitive')}</li>
    <li>${t('pages.participants.sheetsLink.spacesUnderscores', 'Spaces and underscores are treated the same')}</li>
    <li>${t('pages.participants.sheetsLink.correctMapping', 'You can correct any auto-detected mapping in the import view')}</li>
  </ul>`;
}
