...
const getRoleOptions = () => [
  { label: t('roles.competitor'), value: COMPETITOR },
  { label: t('roles.official'), value: OFFICIAL },
  { label: t('roles.coach'), value: COACH },
  { label: t('roles.medical'), value: MEDICAL },
  { label: t('roles.security'), value: SECURITY },
  { label: t('roles.media'), value: MEDIA },
];
