import { createLangToggleButton } from 'services/i18n/languageSwitcher';
/**
...
export function rootBlock(): HTMLElement {
  ...
  const placeholder = document.getElementById('langTogglePlaceholder');
  if (placeholder) {
    const langBtn = createLangToggleButton();
    placeholder.replaceWith(langBtn);
  }
...
function newBlock(): HTMLDivElement {
  ...
  block.innerHTML = `<div id='dnav'>
    ...
    <div class="navbar-item" style="font-size: 1em; display: flex; align-items: center; gap: 2px;">
      <span id="langTogglePlaceholder"></span><i id="themeToggle" style="cursor: pointer; padding: 0 .4em; opacity: 0.7;" class="fa-solid fa-moon" title="Toggle theme"></i>
